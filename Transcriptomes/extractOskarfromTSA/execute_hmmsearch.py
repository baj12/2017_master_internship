...
for protein in bar(protein_folder) :
    ...
    if os.path.isfile(path) :
        ...
        os.system('hmmsearch --tblout ./oskar_search/{}_oskar_search/{}_osk_search.txt {} {}'.format(protein,output,oskModel,path))
        os.system('hmmsearch --tblout ./oskar_search/{}_oskar_search/{}_lotus_search.txt {} {}'.format(protein,output,lotusModel,path))
