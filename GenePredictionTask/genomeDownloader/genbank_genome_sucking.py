...
for index in dataToFetch.index :
    if 'GCA' in dataToFetch['genome_id'][index] :
        gIDtofetch.append(dataToFetch['genome_id'][index])

if not os.path.isdir(os.path.join(genomePath, 'Genbank_Genomes')):
	os.mkdir(os.path.join(genomePath, 'Genbank_Genomes'))
